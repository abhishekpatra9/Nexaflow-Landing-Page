      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-slate-300 text-sm mb-6 leading-relaxed">
              Transform your workflow with Nexaflow, the next-generation platform built for modern teams.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {productLinks.map((link) => (
                <li key={link.name}>
                  <a href={link.href} className="text-slate-300 text-sm hover:text-white transition-colors">
                    {link.name}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">© {new Date().getFullYear()} Nexaflow. All rights reserved.</p>
